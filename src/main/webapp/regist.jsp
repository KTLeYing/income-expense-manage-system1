...
<head>
    ...
    <%--图标--%>
    <link rel="shortcut icon" href="static/images/m1.png">
    ...
    <!-- 引入自定义样式 -->
    <link rel="stylesheet"
          href="static/css/regist.css">
    <script type="text/javascript"
            src="static/js/regist.js">
                ...
                <form
                    ...
                    <div class="form-group form-inline">
                        <div class="input-group form-inline">
                            ...
                            <div>
                                <input type="emailCode" class="form-control col-xs-8" placeholder="请输入邮箱验证码"
                                           name="emailCode" id="emailCode" required="required" <%--style="float: left; width: 62%"--%>>
                                 <input type="button" name="codebtn" id="codebtn" value="获取验证码" class="form-control col-xs-4" <%--style="float: right; width: 35%;
