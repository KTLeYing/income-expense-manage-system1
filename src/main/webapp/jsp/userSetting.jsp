...
<head>
    ...
    <!-- 自定义控件 -->
    <link rel="stylesheet"
          href="${pageContext.request.contextPath}/static/css/userSetting.css">
    <script type="text/javascript"
            src="${pageContext.request.contextPath}/static/js/userSetting.js">
    ...
    <script type="text/javascript"
            src="${pageContext.request.contextPath}/static/app/js/offcanvas.js"></script>
    <script type="text/javascript">
...
<nav class="navbar navbar-default navbar-static-top" style="background: #B3E5FC">
    <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse sidebar-offcanvas">
            ...
            <ul class="nav navbar-nav">
                ...
                <li><a
                        href="${pageContext.request.contextPath}/news/findNewsList.action?currentPage=0">收支新闻</a></li>
            </ul>
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown" id="user_setting">
                    ...
                    <ul class="dropdown-menu" role="menu"
                        aria-labelledby="dropdownMenu1" style="background: #B3E5FC">
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <input type="hidden" id="oldusername" name="oldusername"
                                               value="${oldusername }"> <input type="text"
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <input type="email" class="form-control" placeholder="请输入邮箱"
                                               name="email" id="email" value="${user.email }" required="required">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="请输入手机号"
                                               name="phone" id="phone" value="${user.phone }" required="required">
                                    </div>
                                </div>
