...
<head>
    ...
    <!-- 手机响应式侧边栏的相关css文件 -->
    <link rel="stylesheet"
          href="${pageContext.request.contextPath}/static/app/css/bootstrap.min.css">
    <link rel="stylesheet" type="text/css"
          href="${pageContext.request.contextPath}/static/app/css/default.css">
    <link
            href="${pageContext.request.contextPath}/static/app/css/offcanvas.min.css"
    ...
    <!-- 引入highcharts文件 -->
    <script
            src="${pageContext.request.contextPath}/static/highcharts/highcharts.js"></script>
    <script src="${pageContext.request.contextPath}/static/highcharts/exporting.js"></script>
    <script
            src="${pageContext.request.contextPath}/static/highcharts/highcharts-zh_CN.js"></script>
    <script
            src="${pageContext.request.contextPath}/static/highcharts/highcharts-more.js"></script>

    <!-- 自定义文件 -->
    <link rel="stylesheet"
          href="${pageContext.request.contextPath}/static/css/main.css">
    <link rel="stylesheet"
          href="${pageContext.request.contextPath}/static/css/financialCount.css">
    <script type="text/javascript"
            src="${pageContext.request.contextPath}/static/js/financialCountYear.js"></script>
    <script type="text/javascript"
            src="${pageContext.request.contextPath}/static/js/financialCountMonth.js"></script>
    <script type="text/javascript"
            src="${pageContext.request.contextPath}/static/js/financialCountTime.js"></script>
    ...
    <link rel="stylesheet"
          href="${pageContext.request.contextPath}/static/bootstrap/cal/SimpleCalculadorajQuery.css">
    <script
            src="${pageContext.request.contextPath}/static/bootstrap/cal/SimpleCalculadorajQuery.js"></script>

    <script type="text/javascript" src="${pageContext.request.contextPath}/static/app/js/offcanvas.js"></script>
    <script type="text/javascript">
...
<nav class="navbar navbar-default navbar-static-top" style="background: #24b9ec">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" style="background: #24b9ec"><span style="background: linear-gradient(to right, red, blue); -webkit-background-clip: text; color: transparent; font-weight: bold">智能收支管理平台</span></a>
        </div>
        <div id="navbar" class="collapse navbar-collapse sidebar-offcanvas">
            <!-- 导航元素 -->
            <ul class="nav navbar-nav">
                <li><a
                        href="${pageContext.request.contextPath}/shouzhiRecord/findShouzhiRecord.action">收支管理</a></li>
                <li class="active"><a
                        href="${pageContext.request.contextPath}/toFinancialCount.action">收支统计</a></li>
                <li><a
                        href="${pageContext.request.contextPath}/financialAnalysis/toFinancialAnalysis.action">收支分析</a></li>
                <li><a
                        href="${pageContext.request.contextPath}/budget/findBudget.action">收支预算</a></li>
                <li><a
                ...
                <li><a
                        href="${pageContext.request.contextPath}/news/findNewsList.action?currentPage=0">理财新闻</a></li>
            </ul>
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown" id="user_setting">
                    ...
                    <ul class="dropdown-menu" role="menu"
                        aria-labelledby="dropdownMenu1" style="background: #24b9ec">
