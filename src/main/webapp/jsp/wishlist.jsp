...
<head>
    ...
    <script type="text/javascript"
            src="${pageContext.request.contextPath}/static/js/wishlist.js">
    ...
    <script type="text/javascript">
        ...
        function toeditPage(id) {//去修改信息页面
            ...
            $.ajax({
                type : "get",
                url : "/" + window.document.location.pathname.split("/")[1] + "/wishlist/toEdit.action",
                data : {
                    "id" : id
                },
        ...
        function deleteWish(id) {
            if (confirm('确认要删除该条记录吗?')) {
                $.post("/" + window.document.location.pathname.split("/")[1] + "/wishlist/deleteWish.action", {
                    "id" : id
                }, function(data) {
...
<nav class="navbar navbar-default navbar-static-top" style="background: #AED581">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" style="background: #AED581"><span style="background: linear-gradient(to right, red, blue); -webkit-background-clip: text; color: transparent; font-weight: bold">智能收支管理平台</span></a>
        </div>
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown" id="user_setting">
                    ...
                    <ul class="dropdown-menu" role="menu"
                        aria-labelledby="dropdownMenu1" style="background: #AED581">
