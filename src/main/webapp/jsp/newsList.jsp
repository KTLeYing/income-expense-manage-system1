...
<head>
    ...
    <link rel="stylesheet"
          href="${pageContext.request.contextPath}/static/css/newsList.css">
    ...
    <script type="text/javascript"
            src="${pageContext.request.contextPath}/static/js/newsList.js"></script>
...
<nav class="navbar navbar-default navbar-static-top" style="background: #F24D4B">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" style="background: #F24D4B"><span style="background: linear-gradient(to right, red, blue); -webkit-background-clip: text; color: transparent; font-weight: bold">智能收支管理平台</span></a>
        </div>
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown" id="user_setting">
                    ...
                    <ul class="dropdown-menu" role="menu"
                        aria-labelledby="dropdownMenu1" style="background: #F24D4B">
            ...
            <div class="starter-template">
                <div class="row">
                    <div class="col-lg-5 col-lg-offset-1 col-md-5 col-md-offset-1">
                        <h2 class="banner-title" id="jieshao">理财新闻</h2>
                    ...
                    <div class="col-lg-5 col-md-5 hidden-sm hidden-xs">
                        <img src="${pageContext.request.contextPath}/static/images/person.png" class="img-responsive">
                    </div>
                </div>
            </div>
        </div>
