...
<head>
    ...
    <%--图标--%>
    <link rel="shortcut icon" href="${pageContext.request.contextPath}/static/static/images/m1.png">
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/static/js/memorandum.js">
    </script>
...
<body>
<!-- 导航栏的制作 -->
<nav class="navbar navbar-default" role="navigation" style="background: #80CBC4">
    <div class="container">
        <!-- 导航头部 -->
        ...
        <div class="collapse navbar-collapse" id="home-navbar-collapse">
            ...
            <ul class="nav navbar-nav">
                <li ><a href="${pageContext.request.contextPath}/shouzhiRecord/findShouzhiRecord.action">收支管理</a></li>
                <li><a
                        href="${pageContext.request.contextPath}/toFinancialCount.action">收支统计</a></li>
                <li><a href="${pageContext.request.contextPath}/financialAnalysis/toFinancialAnalysis.action">收支分析</a></li>
                <li><a href="${pageContext.request.contextPath}/budget/findBudget.action">收支预算</a></li>
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown" id="user_setting">
                    ...
                    <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1"  style="background: #80CBC4">
                ...
                <form name="upfile" action="${pageContext.request.contextPath}/memorandum/addMemorandum.action" method="post">
                    <div class="row">
                        ...
                        <div  class="col-md-8 col-xs-8" style="text-align:right;">
                            <span style="color:green;" class="addZiti">添加备忘</span>
                        </div>
                    </div>
                    ...
                    <!-- 						<button  type="submit" class="btn btn-primary" onclick="return getPlainTxt()">添加备忘</button> -->
                    <button  type="submit" class="btn btn-primary" onclick="return getPlainTxt()">添加备忘</button>
