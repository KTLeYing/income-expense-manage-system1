...
<head>
    ...
    <!-- 自定义控件 -->
    <link rel="stylesheet"
          href="${pageContext.request.contextPath}/static/css/memorandum.css">
    <script type="text/javascript"
            src="${pageContext.request.contextPath}/static/js/memorandum.js">
    ...
    <script type="text/javascript">
        ...
        function deleteMemorandum(mid, currentPage) {
            if (confirm('确认要删除该条记录吗?')) {
                alert("删除记录成功！");
                window.location.href = "/" + window.document.location.pathname.split("/")[1] + "/memorandum/deleteMemorandum.action?currentPage="
                    + currentPage + "&mid=" + mid;
            }
        };
    </script>
...
<nav class="navbar navbar-default navbar-static-top" style="background: #80CBC4">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" style="background: #80CBC4"><span style="background: linear-gradient(to right, red, blue); -webkit-background-clip: text; color: transparent; font-weight: bold">智能收支管理平台</span></a>
        </div>
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown" id="user_setting">
                    ...
                    <ul class="dropdown-menu" role="menu"
                        aria-labelledby="dropdownMenu1" style="background: #80CBC4">
