...
<head>
    ...
    <link rel="stylesheet"
          href="${pageContext.request.contextPath}/static/css/financialAnalysis.css">
    <script type="text/javascript"
            src="${pageContext.request.contextPath}/static/js/financialAnalysis.js"></script>
...
<nav class="navbar navbar-default navbar-static-top" style="background: #f0ad4e">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" style="background: #f0ad4e"><span style="background: linear-gradient(to right, red, blue); -webkit-background-clip: text; color: transparent; font-weight: bold">智能收支管理平台</span></a>
        </div>
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown" id="user_setting">
                    ...
                    <ul class="dropdown-menu" role="menu"
                        aria-labelledby="dropdownMenu1" style="background: #f0ad4e">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div style="background-color: #F0AD4E;color:white;">
                                        <span id="month_start">本月收支状况</span>
                                    </div>
                                    <div id="top_left">
                                ...
                                <div class="col-md-12" style="font-size:20px;color:red;">
                                    收支分析：<br /> <span id="allIncome"> 同比上月, 收入<span
                                ...
                                <div class="col-md-12" style="font-size:18px;color:red;">
                                    收支分析：<br /> <span id="spendAnalysis"></span>
                                </div>
