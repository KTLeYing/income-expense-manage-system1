...
<head>
    ...
    <link rel="stylesheet"
          href="${pageContext.request.contextPath}/static/css/financialBudget.css">
    <script type="text/javascript"
            src="${pageContext.request.contextPath}/static/js/financialBudget.js"></script>
...
<nav class="navbar navbar-default navbar-static-top" style="background: #f1c40f">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" style="background: #f1c40f"><span style="background: linear-gradient(to right, red, blue); -webkit-background-clip: text; color: transparent; font-weight: bold">智能收支管理平台</span></a>
        </div>
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown" id="user_setting">
                    ...
                    <ul class="dropdown-menu" role="menu"
                        aria-labelledby="dropdownMenu1" style="background: #f1c40f">
