...
<head>
    ...
    <!-- 手机响应式侧边栏的相关css文件 -->
    <link rel="stylesheet" href="${pageContext.request.contextPath}/static/app/css/bootstrap.min.css">
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/app/css/default.css">
    <link href="${pageContext.request.contextPath}/static/app/css/offcanvas.min.css" rel="stylesheet" type="text/css">
...
<%--    <!-- 	src="${pageContext.request.contextPath}/jquery-easyui-1.5.4.2/jquery.min.js"></script> -->--%>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/static/bootstrap/cal/SimpleCalculadorajQuery.css">
    <script src="${pageContext.request.contextPath}/static/bootstrap/cal/SimpleCalculadorajQuery.js"></script>
    ...
    <script type="text/javascript">
        ...
        function toeditPage(id) {
            ...
            $.ajax({
                    type : "get",
                    url : "<%= request.getContextPath()%>/shouzhiRecord/toEdit.action",
                    data : {
                        "id" : id
                    },
...
// 								data.shouzhiRecord.szr_date);
        ...
        function updateShouzhiRecord() {
            $.post("<%= request.getContextPath()%>/shouzhiRecord/edit.action", $("#updateform")
        ...
        function deleteshouzhiRecord(id) {
            if (confirm('确认要删除该收支记录吗?')) {
                $.post("<%= request.getContextPath()%>/shouzhiRecord/deleteOne.action", {
                    "id" : id
                }, function(data) {
                    //回调为ok时，弹出alert框，并重新刷新页面
                    alert("删除收支记录成功！");
...
<nav class="navbar navbar-default navbar-static-top" style="background: #2ecc71">
    <div class="container">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown" id="user_setting">
                    ...
                    <ul class="dropdown-menu" role="menu"
                        aria-labelledby="dropdownMenu1" style="background: #2ecc71" >
