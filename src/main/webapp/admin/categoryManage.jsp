...
<head>
    ...
    <script type="text/javascript"
            src="${pageContext.request.contextPath}/static/js/admin/categoryManage.js"></script>

    <link type="text/css" rel="stylesheet"
          href="${pageContext.request.contextPath}/static/css/admin/main.css">
    ...
    <script type="text/javascript">
        ...
        function toshouzhiCategoryEditPage(szcid){//异步交互事件
            $.ajax({
                type : "get",
                url : "/" + window.document.location.pathname.split("/")[1] + "/categoryManage/toEditPage.action",
                data : {"szcid":szcid},
...
// 		alert("uid:"+uid);
            ...
            if (confirm('确认要删除该收支信息吗?')) {
                ...
                $.ajax({
                    type : "get",
                    url : "/" + window.document.location.pathname.split("/")[1] + "/categoryManage/ajaxConfirmDeleteShouzhiCategory.action",
                    data : {"szcid":szcid},
                    contentType:"application/json;charset=utf-8",/* 发送数据给服务器时所用的内容类型	*/
                    dataType : "json",//返回时的数据类型json
                    success : function(data) {
// 					alert("成功");
                        if(data.name=="yes"){//可以删除
                            alert("删除收支类型成功！");
                            //跳转到删除收支信息action
                            window.location.href= "/" + window.document.location.pathname.split("/")[1] + "/categoryManage/deleteShouzhiCategory.action?szcid="+szcid+"&currentPage2="+currentPage2;
                        }
                        else{
                            ...
                            >
                                ...
                                <div class="modal-body"><!-- 在这里添加一些文本 -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="请输入收支类型"
