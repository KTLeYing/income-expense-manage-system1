...
<head>
    ...
    <link rel="stylesheet"
          href="${pageContext.request.contextPath}/static/css/admin/news/editnews.css">
    <script type="text/javascript" charset="utf-8"
            src="${pageContext.request.contextPath}/static/js/admin/editnews.js"></script>
                        ...
                        <form name="upfile" id="upfile" method="post"
                            ...
                            <div class="row">
                                <div class="col-md-12 col-xs-12">
                                    <a onclick="javascript :history.back(-1);"> <span
