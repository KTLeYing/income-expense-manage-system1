    ...
    <script type="text/javascript">
        ...
        function deleteNews(nid) {
            ...
            if (confirm('确认要删除该条新闻信息吗?')) {
                window.location.href= "/" + window.document.location.pathname.split("/")[1] + "/newsManage/deleteNews.action?nid="+nid+"&currentPage2="+currentPage2;
            }
        }
    </script>
</head>
    ...
    <div class="row">
        ...
        <div class="col-md-10">
            ...
            <div id="newsManage" class="tab-pane fade in active">
                <div class="row">
                    <div class="col-md-10">
                        <h1 class="page-header">理财新闻管理</h1>
                    </div>
                    <div class="col-md-2">
                ...
                <c:if test="${ pageBean.pageList==null}">
                    <h1 style="color:red;">当前理财新闻为空</h1>
                </c:if>
                <c:if test="${ pageBean.pageList!=null}">
                    <!-- mytable用来控制宽高 -->
                    <div class="mytable">
