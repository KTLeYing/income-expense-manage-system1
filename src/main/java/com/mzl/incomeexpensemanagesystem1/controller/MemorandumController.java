...
import com.mzl.incomeexpensemanagesystem1.entity.Memorandum;
import com.mzl.incomeexpensemanagesystem1.entity.PageBean;
import com.mzl.incomeexpensemanagesystem1.entity.User;
import com.mzl.incomeexpensemanagesystem1.service.MemorandumService;
...
public class MemorandumController {
    ...
    public  String listMemorandum(HttpServletRequest request, Integer currentPage, Model model){
        ...
        return "/jsp/memorandum/memorandum";
    }
...
//        System.out.println(path);
//        String realPath = path + "\\webapps" + request.getContextPath().replace("/", "\\") + "\\file\\memorandum\\" + thingPath;
//        System.out.println(realPath);
...
//        System.out.println(realPath);
        ...
        //返回到编辑页面
        return "/jsp/memorandum/editmemorandum";
    }
...
//        System.out.println(arr[0]);
        ...
        //判断文件夹是否存在，不存在就自己创建
//        String path = "D:\\Program Files\\MyFilesPractice(own)\\memorandum";
        String path = "D:/Program Files/MyFilesPractice(own)/memorandum";
//        String path = "/myFiles/memorandum";
...
//        String realPath = path + "\\" + thingPath;
        ...
        memorandum.setThingPath(realPath);
