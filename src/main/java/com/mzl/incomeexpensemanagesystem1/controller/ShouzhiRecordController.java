...
import com.mzl.incomeexpensemanagesystem1.entity.*;
import com.mzl.incomeexpensemanagesystem1.service.NewsService;
...
/**
 * @ClassName :   ShouzhiRecordController
 * @Description: 收支记录控制器
 * @Author: 21989
...
//				request.getSession().setAttribute("comment_condition", com);
                request.setAttribute("comment_condition", shouzhiRecord.getSzr_comment());
                shouzhiRecord.setSzr_comment(shouzhiRecord.getSzr_comment());//重新赋值
            }
        }
...
/*		request.getSession().setAttribute("currentCategory", shouzhiRecord.getShouzhiCategory().getSon_category());
    ...
    public String editShouzhiRecord(ShouzhiRecord shouzhiRecord, HttpServletRequest request){
        ...
        //把收支的子类型封装在收支类型的实体类对象shouzhi_category中作为参数
        ShouzhiCategory shouzhiCategory1 = new ShouzhiCategory();
